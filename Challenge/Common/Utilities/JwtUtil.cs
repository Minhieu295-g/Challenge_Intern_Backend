...
namespace Common.Utilities
{
    public static class JwtUtil
    {
        ...
        public static (string AccessToken, string RefreshToken) CreateJwtAndRefreshToken(JwtTokenSetting jwtTokenSetting, AuthenticatedUserModel user, string userRole)
        {
            var accessToken = CreateJwtToken(jwtTokenSetting, user, userRole);
        ...
        public static bool ValidateRefreshToken(string refreshToken, string storedRefreshToken, DateTime storedExpiryDate)
        {
            if (refreshToken != storedRefreshToken)
                return false;

            if (DateTime.UtcNow > storedExpiryDate)
                return false;
